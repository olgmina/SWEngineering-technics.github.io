...
_Шаблон_ (Moore, Geoffrey A. 1991. Crossing the Chasm: Marketing and Selling High-Tech Products to Mainstream Customers. New York: HarperBusiness):
...
[Детальный шаблон](requierements/templates/concept.md)
...
2. Смоделируйте для  каждого выделенного действующего лица варианты использования (нарисуйте диаграммы use-case). ([Рекомендации по созданию прецендентов)](https://github.com/olgmina/SWEngineering-technics.github.io/blob/6e195a5990e220f19e779ea7af3f587594622623/%D0%9C%D0%BE%D0%B4%D0%B5%D0%BB%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5_%D0%BF%D1%80%D0%B5%D1%86%D0%B5%D0%B4%D0%B5%D0%BD%D1%82%D0%BE%D0%B2.pdf))
   
    2.1 Выделите пользователя и его цель, например, прочитать блог, сделать заказ, выпить кофе
    
    2.2 Опишите последовательность действий пользователя для достижения цели
    
    2.3 Придумайте альтернативный сценарий
    
    _Возможно удобнее нарисовать сценарий в виде диаграммы последовательности или деятельности_
...
Шаблон для описания требований:
![image](https://github.com/olgmina/SWEngineering-technics.github.io/assets/65451923/66128d72-47e3-4045-8b58-ddbcab6ece1a)

  
## Документирование требований
Результаты сбора, анализа и систематизации требований документируются в  виде различного рода спецификации (SRS, технического задания)
