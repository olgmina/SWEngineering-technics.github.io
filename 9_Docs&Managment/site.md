...
Загрузить проект в среду разработки. 
Установить плагин для работы Markdown. 
Поправить разметку.
...
##Задание 4. Возьмите класс, разработанного Вами программного модуля и полностью прокомментируйте его.
...
_Задание 6._ Составьте руководство пользователя для Вашей программы на Wiki-страницах
...
_Задание 7._ Напишите инструкцию по установке Вашего приложения install.md
...
- повернуть отвертку на 90 град. по часовой стрелке (рисунок, поясняющий результат).
 ...
 _Задание 8._ Создание контекстной справки
 
 Дополните Ваш программный код справкой и подсказками
 
Пример кода для GUI на javafx для добавления подсказки к виджету:

``
final String tips = "сделайте что-нибудь!"
