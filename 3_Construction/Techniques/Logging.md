...
Ведение логов включает:
 
- запись их в соответствующий файл или базу данных, снабжение меткой времени и идентификатором источника, 
- агрегирование (объединение одинаковых или схожих записей), 
- своевременное удаление старых записей и т.д. 
Ведение логов может осуществляться самой генерирующей программой, а может быть передано специализированной (логирующей) программе, такой как «syslogd» или же сохраненный файл логов загружается  и анализируется в Excel или другой программе анализа данных.
- Генерация логов
