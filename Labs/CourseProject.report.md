...
- задачи оптимизации трудозатрат при решении задач поиска и анализа.
  ...
  [Концепция программы](requierements/Techniques/templates/concept.md) представлена в приложении 1.
 ...
 ### 1.2 Функциональное назначение:
  ...
  [Сценарии использования](requierements/Techniques/templates/scanario.md) <указать название> - в приложении 2
