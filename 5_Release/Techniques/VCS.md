# Введение в Git как систему управления версиями

*Помните свой проект, когда вы сохраняли файлы с названиями "final", "final_final", "final_FINAL_version2"? Или тот момент паники, когда вы случайно удалили важный код и не могли его восстановить?*
