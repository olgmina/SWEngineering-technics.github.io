...
_Паттерны: Обучающие ресурсы с примерами_

[Design Patterns in Java Tutorial](https://www.tutorialspoint.com/design_pattern/index.html)

_Структуры данных_

- [Реализация ArrayList - открытый код](https://hg.openjdk.org/jdk7/jdk7/jdk/file/9b8c96f96a0f/src/share/classes/java/util/ArrayList.java)
- [](https://www3.ntu.edu.sg/home/ehchua/programming/java/J5c_Collection.html)
- [Лефоре Структуры данных и алгоритмы](https://cobooks.info/books/robert-lafore-struktury-dannyh-i-algoritmy-v-java-2-e-izdanie1502790099-f5da9a7b93-ru.pdf)
-     [Демо-примеры на апплетах](https://www.cs.brynmawr.edu/Courses/cs206/spring2004/lafore.html)  Аплеты — это небольшие демонстрационные программы, поясняющие темы книги.
Например, для демонстрации алгоритмов сортировки отображается гистограмма, и каждый раз, когда пользователь нажимает кнопку апплета, выполняется еще один шаг алгоритма. Можно увидеть, как движутся полосы, а аннотации в апплете объясняют, что происходит.
-     [коды к книге](https://github.com/aymanmobarak/Lafore/blob/master/src/Chap03/SelectSort/selectSort.java)

### Задача 1 Использование коллекций
В Java динамически выделяемые структуры данных (такие как ArrayList, LinkedList, Vector, Stack, HashSet, HashMap, Hashtable) поддерживаются в единой архитектуре , называемой Collection Framework , которая определяет общее поведение всех классов.

Коллекция , как следует из ее названия, — это просто объект-контейнер , содержащий коллекцию объектов . Каждый элемент коллекции называется элементом . Фреймворк по определению — это набор интерфейсов, которые заставляют вас применять некоторые методы проектирования . Хорошо спроектированная структура может повысить вашу производительность и обеспечить простоту обслуживания.

Платформа коллекции предоставляет унифицированный интерфейс для хранения, извлечения и управления элементами коллекции, независимо от базовой фактической реализации. Это позволяет программистам программировать по спецификации интерфейса, а не по фактической реализации.

Пакет Java Collection Framework ( java.util) содержит:

- Набор интерфейсов,
- Классы реализации и
- Алгоритмы (такие как сортировка и поиск).
  [Детально](https://www3.ntu.edu.sg/home/ehchua/programming/java/J5c_Collection.html)
