...
Индексированная папка — список отслеживаемых git-ом файлов и каталогов, промежуточное хранилище изменений (редактирование, удаление изменений в отслеживаемых файлов).
